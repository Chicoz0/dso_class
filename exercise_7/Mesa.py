...
class Mesa(AbstractMesa):
    ...
    def __init__(self, jogador1: Jogador, jogador2: Jogador,
        ...
        if isinstance(jogador1, Jogador) and \
            jogador1 is not None and \
            isinstance(jogador2, Jogador) and \
            jogador2 is not None and \
            isinstance(cartaJogador1, Carta) and \
            cartaJogador1 is not None and \
            isinstance(cartaJogador2, Carta) and \
                cartaJogador2 is not None:
